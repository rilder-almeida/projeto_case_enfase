...
def solucoes():
    ...
    st.markdown(
        ...
        a concentração de pedidos vendidos no Sudeste do país, 86.5% do total, principalmente nos estados
        ...
        predominantemente, no Sudeste e Sul. Uma possível solução seria focar ações de marketing concentrando-se em
        estados como a Bahia, Distrito Federal e Espírito Santo, pelo fato de estarem próximos e possuírem bons mercados
    ...
    st.markdown(
        ...
        Para identificar falhas e entender melhor a complexidade da logística de entregas foram realizadas diversas análises em cada uma das etapas:
        entre a compra e o envio, entre o envio e a entrega. Tanto por parte do comprador quanto por parte do vendedor,
        sob perspectivas de localização, como estado, região e capital/interior, parametrizados pela quantidade relativa de pedidos.<br>
       ...
       seria a busca de empresas de logística terceirizadas com mais agilidade fora das capitais, como a Jadlog e a Mercado Envios, a fim de reduzir esta falha de operação e 
        ...
        múltiplas empresas, buscando aquela que atenda melhor cada região ou estado. Outra possibilidade é a viabilização de um modelo híbrido de logística fulfillment,
