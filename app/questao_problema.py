...
def case():
    ...
    cuidadosamente selecionados e aprovados em um processo criterioso.<br><br>
    ...
    acertadas no quesito de carteira de produtos e profitabilidade.<br><br>
    ...
    desde o ato da compra até a entrega, observando os prazos e atrasos, os tempos de operação
    e os valores dos fretes, em séries geográficas e temporais. Tendo como intúito
    ...
    <div style="text-align: justify">
    ## Etapas
    Para melhor execução dos objetivos do projeto, o mesmo foi dividido da seguinte maneira:
    ...
    - Elaboração das funções e widgets relacionadas às necessidades da análise;
